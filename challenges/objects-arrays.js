...
console.log(`velociraptor's diet was ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`stegosaurus was ${stegosaurus.length} long.`);

// What time period did tyrannosaurus live in?
console.log(`tyrannosaurs lived during the ${tyrannosaurus.period} period.`);
...
for (let i = 0; i < graduates.length; i++) {
  ...
  regex.test(graduates[i].university) && uni.push(graduates[i].university);
}
